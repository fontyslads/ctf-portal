...
class Platform extends React.Component {
  ...
  componentDidMount() {
    ...
    tl.to(this.screenBackground.current, {
      fill: "red",
      delay: 1,
      repeat: -1,
      ease: "none",
    ...
    //TODO if first flag submitted (or after some time?)
    tl.to(this.textBubble.current, {
      opacity: 1,
      ease: "ease",
      delay: 1,
      duration: 0.5,
          ...
          <g id="person_4">
            ...
            >
              <path
                ...
                d="M593.885 547.347L593.662 546.847L593.121 546.766C566.6 542.785 544.455 537.037 528.968 530.156C521.222 526.714 515.194 523.012 511.118 519.148C507.043 515.284 505 511.341 505 507.388C505 501.527 509.51 495.686 518.322 490.179C527.082 484.705 539.824 479.739 555.658 475.553C587.313 467.187 631.098 462 679.5 462C727.902 462 771.687 467.187 803.342 475.553C819.176 479.739 831.918 484.705 840.678 490.179C849.491 495.686 854 501.527 854 507.388C854 513.248 849.491 519.089 840.678 524.596C831.918 530.07 819.176 535.037 803.342 539.222C771.687 547.589 727.902 552.775 679.5 552.775C654.878 552.775 631.446 551.433 610.195 549.012L609.682 548.953L609.338 549.338L599.612 560.184L593.885 547.347Z"
                fill="white"
                stroke="black"
                strokeWidth="2"
              />
